...
class DayLogDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final showCompletedWorkout = isCompleted || hasLogs;

    if (isLoading && !showCompletedWorkout) {
      return const Center(
              ...
              Column(
                children: logs.map((log) {
                  final exercisesWithSets =
                      log.exercises.where((ex) => ex.sets.isNotEmpty).toList();

                  final workoutName = "Workout (${log.day})";
                  final workoutTime = DateFormat.jm().format(log.endedAt);
                              ...
                              return Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (exercise != exercisesWithSets.last)
