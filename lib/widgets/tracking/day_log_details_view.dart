                  ...
                  : logs.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final exercisesWithLoggedSets = log.exercises
                                .where((ex) => ex.loggedSets.isNotEmpty)
                                .toList();

                            final String workoutTime =
                                DateFormat.jm().format(log.endTime);
                              ...
                              child: ExpansionTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${exercisesWithLoggedSets.length} exercises completed",
                                      style: textTheme.bodySmall?.copyWith(
                                        color: colorScheme.primary,
                                ...
                                children: exercisesWithLoggedSets.isEmpty
                                    ? [
                                        Padding(
                                                ...
                                                return Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Text(
                                                          set.performedWeightKg !=
                                                                      'N/A' &&
                                                                  set.performedWeightKg !=
                                                                      '-'
                                                              ? "${set.performedReps} reps · ${set.performedWeightKg} kg"
