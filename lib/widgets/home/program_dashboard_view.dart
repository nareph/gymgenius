...
class ProgramDashboardView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Safe conversion of raw exercises to List<Exercise> ---
    final rawTodaysExercises = weeklySchedule[todayDayKey] as List? ?? [];
    final todaysExercises = rawTodaysExercises
    ...
    return ListView(
      ...
      children: [
        ...
        if (weeklyWorkout != null)
          Text(
            "Week ${weeklyWorkout!.weekNumber} of ${program.durationInWeeks}",
        ...
        if (!program.isExpired()) ...[
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final rawExercises = weeklySchedule[dayKey] as List? ?? [];
              // Safe conversion
              final dayExercises = rawExercises
                  .map((e) =>
