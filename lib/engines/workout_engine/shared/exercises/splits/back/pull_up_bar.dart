...
const List<ExercisePoolEntry> backPullUpBarExercises = [
  ExercisePoolEntry(
    id: 'back_pullup_pull_ups',
    name: 'Pull-ups',
  ...
  ExercisePoolEntry(
    ...
    planeOfMotion: PlaneOfMotion.sagittal,
    description: '**Target: Back, Biceps**\n\n'
        '1. Use parallel handles or a neutral grip on the bar.\n'
        '2. Pull up, keeping elbows close.\n'
        '3. Lower with control.',
  ),
  ExercisePoolEntry(
    id: 'back_pullup_commando',
    ...
    description: '**Target: Back, Biceps, Core**\n\n'
        ...
        '2. Pull up, alternating the lead hand on each rep.\n'
        '3. Lower with control.',
  ),
];
