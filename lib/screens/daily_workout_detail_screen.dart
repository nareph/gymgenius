                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            ...
                            "${exercise.weightSuggestionKg.isNotEmpty && exercise.weightSuggestionKg.toLowerCase() != 'bodyweight' ? ' @ ${exercise.weightSuggestionKg}kg' : (exercise.weightSuggestionKg.toLowerCase() == 'bodyweight' ? ' (Bodyweight)' : '')}"
                          ...
                          TextButton(
                            onPressed: () {
                              ...
                              workoutManager.forceStartNewWorkout(
                                ...
                                routineId: widget.programIdForLog,
